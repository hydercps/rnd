...
void draw() {
  ...
  for (int z = 0; z < 20; z++) {
    ...
    for (int i = 0; i < 25; i++) {
      ...
      point(i*10, (height/2)+sin((frameCount+i*3)/freq)*(amp*1));
      ...
      for (int x = 1; x < 8; x++) {
        ...
        point(i*10, (height/2-(x*10)) + sin((frameCount+i*3)/freq) * (amp*(1-(x*0.13))));
        ...
        point(i*10.5-5, (height/2-(x*12)) + cos((frameCount+i*3)/freq) * (amp*(1-(x*0.13))));
